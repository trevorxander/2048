...
class CompetitionAreaUI(object):
    ...
    def setupUi(self, competition_area):
        ...
        self.timer = Label(parent=competition_area, label='Timer', val=60)
        ...
        competition_area.setMaximumSize(
            QtCore.QSize(ScoreTrackerUI.SCORE_WIDTH * 2 - (ScoreTrackerUI.OVERLAP - 2), 500))
...
class ScoreTrackerUI(object):
    ...
    def setupUi(self, score_tracker):
        ...
        self.left.setMinimumSize(QtCore.QSize(20, 100))
